...
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=10672208&assignment_repo_type=AssignmentRepo)
# Battleship [![Docker Build & Push](https://github.com/softeng2223-inf-uniba/progetto2223-cocke/actions/workflows/docker_build&push.yml/badge.svg)](https://github.com/softeng2223-inf-uniba/progetto2223-cocke/actions/workflows/docker_build&push.yml)
...
- `docs/`: ospita la documentazione di progetto, incluse le figure (nella sottocartella `img/`).
  ...
  - `CODE_OF_CONDUCT.md`: contente il codice di comportamento del gruppo; 
  ...
  - `IPRIRATORE.md`: contenente la biografia e i principali contributi di uno dei vincitori del ACM Turing Awards, **[John Cocke]**(https://en.wikipedia.org/wiki/John_Cocke_(computer_scientist));
